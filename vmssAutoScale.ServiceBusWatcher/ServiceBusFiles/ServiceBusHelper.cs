...
// ReSharper restore CheckNamespace
{
    ...
    public class ServiceBusHelper
    {
        ...
        private static ServiceBusWatcher.EncodingType encodingType = ServiceBusWatcher.EncodingType.ASCII;
        #endregion
        ...
        /// </summary>
        public static ServiceBusWatcher.EncodingType EncodingType
        {
            get
            {
                return encodingType;
                            ...
                            TransportType transportType)
        {
            Func<bool> func = (() =>
            {
                ...
                try
                {
                    notificationHubTokenProvider = Microsoft.Azure.NotificationHubs.TokenProvider.CreateSharedSecretTokenProvider(issuerName, issuerSecret);
                }
                catch (Exception)
                {
                    // ignored
                ...
                var notificationHubNamespaceManagerSettings = new Microsoft.Azure.NotificationHubs.NamespaceManagerSettings
                {
                ...
                try
                {
                    notificationHubNamespaceManager = new Microsoft.Azure.NotificationHubs.NamespaceManager(namespaceUri, notificationHubNamespaceManagerSettings);
                }
                catch (Exception)
                {
                    // ignored
        ...
        public RelayDescription CreateRelay(RelayDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(relayService, ServiceBusWatcher.EntityType.Relay));
                return relayService;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteRelay(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, ServiceBusWatcher.EntityType.Relay));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public EventHubDescription CreateEventHub(EventHubDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(eventHub, ServiceBusWatcher.EntityType.EventHub));
                return eventHub;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteEventHub(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, ServiceBusWatcher.EntityType.EventHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteEventHub(EventHubDescription eventHubDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(eventHubDescription, ServiceBusWatcher.EntityType.EventHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public ConsumerGroupDescription CreateConsumerGroup(ConsumerGroupDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(consumerGroup, ServiceBusWatcher.EntityType.ConsumerGroup));
        ...
        public void DeleteConsumerGroup(string eventHubName, string name)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(new ConsumerGroupDescription(eventHubName, name), ServiceBusWatcher.EntityType.ConsumerGroup));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteConsumerGroup(ConsumerGroupDescription consumerGroupDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(consumerGroupDescription, ServiceBusWatcher.EntityType.ConsumerGroup));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteNotificationHub(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, ServiceBusWatcher.EntityType.NotificationHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public NotificationHubDescription CreateNotificationHub(NotificationHubDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null)
                    OnCreate(new ServiceBusHelperEventArgs(notificationHub, ServiceBusWatcher.EntityType.NotificationHub));
        ...
        public void DeleteNotificationHub(NotificationHubDescription notificationHubDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(notificationHubDescription, ServiceBusWatcher.EntityType.NotificationHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public QueueDescription CreateQueue(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(queue, ServiceBusWatcher.EntityType.Queue));
                return queue;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteQueue(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, ServiceBusWatcher.EntityType.Queue));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteQueue(QueueDescription queueDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(queueDescription, ServiceBusWatcher.EntityType.Queue));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public TopicDescription CreateTopic(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(topic, ServiceBusWatcher.EntityType.Topic));
                return topic;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteTopic(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, ServiceBusWatcher.EntityType.Topic));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteTopic(TopicDescription topic)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(topic, ServiceBusWatcher.EntityType.Topic));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public SubscriptionDescription CreateSubscription(TopicDescription topicDescription, SubscriptionDescription subscriptionDescription)
        {
            ...
            if (OnCreate != null)
                OnCreate(new ServiceBusHelperEventArgs(new SubscriptionWrapper(subscription, topicDescription), ServiceBusWatcher.EntityType.Subscription));
            return subscription;
        }
        ...
        public void DeleteSubscription(string topicPath, string name)
        {
            ...
            if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(name, ServiceBusWatcher.EntityType.Subscription));
        }
        ...
        public void DeleteSubscription(SubscriptionDescription subscriptionDescription)
        {
            ...
            if (OnDelete != null)
                OnDelete(new ServiceBusHelperEventArgs(subscriptionDescription, ServiceBusWatcher.EntityType.Subscription));
        }
        ...
        public RuleDescription AddRule(SubscriptionDescription subscriptionDescription, RuleDescription ruleDescription)
        {
            ...
            if (OnCreate != null)
                OnCreate(new ServiceBusHelperEventArgs(new RuleWrapper(rule, subscriptionDescription), ServiceBusWatcher.EntityType.Rule));
            return rule;
        }
        ...
        public void RemoveRule(SubscriptionDescription subscriptionDescription, string name)
        {
            ...
            if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(name, ServiceBusWatcher.EntityType.Rule));
        }
        ...
        public void RemoveRule(SubscriptionDescription subscriptionDescription, RuleDescription rule)
        {
            ...
            if (OnDelete != null)
                OnDelete(new ServiceBusHelperEventArgs(new RuleWrapper(rule, subscriptionDescription), ServiceBusWatcher.EntityType.Rule));
        }
        ...
        private static Encoding GetEncoding()
        {
            switch (encodingType)
            {
                case ServiceBusWatcher.EncodingType.ASCII: 
                    return Encoding.ASCII;
                case ServiceBusWatcher.EncodingType.UTF7: 
                    return Encoding.UTF7;
                case ServiceBusWatcher.EncodingType.UTF8: 
                    return Encoding.UTF8;
                case ServiceBusWatcher.EncodingType.UTF32: 
                    return Encoding.UTF32;
                case ServiceBusWatcher.EncodingType.Unicode: 
        ...
        public ServiceBusNamespace GetServiceBusNamespace(string key, string connectionString)
        {
